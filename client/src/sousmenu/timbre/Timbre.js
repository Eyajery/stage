...
<Button onClick={handleOpen} style={{borderColor:"transparent",height:"50px",width:"250px",marginLeft:"-100px",color:"white", fontSize:"12px"}} >  Timbre</Button>
        <Dialog
        open={open}
        onClose={handleClose}
                    ...
                    ,marginLeft:"4px"}} onClick={handleClickOpen}>
                      ...
                      <Button onClick={handleClose} style={{ padding: "5px", marginLeft: "530px",width:"3px"
                       , backgroundColor:"#c72120", color:"white",height:"25px"}} >X</Button>
                        ...
                        <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
                       , fontWeight:"bold", fontSize:"30px"}}  >Modifier un Timbre</DialogTitle>
                        <p>{msg}</p>
                        <DialogContent>
                          <TextField 
                            autoFocus
