...
function Photocopie(){
    ...
    return(
        <div>
        <Button variant="outlined"   style={{borderColor:"transparent",height:"50px",width:"250px",marginLeft:"-80px",color:"white", fontSize:"12px"}}   onClick={handleOpen}>
        Photocopie  </Button>
        <Dialog open={open} onClose={handleClose}>
        ...
        , fontWeight:"bold", fontSize:"20px"}} >Mise à jour des Paramètres</DialogTitle>
          ...
          <TextField 
            ...
            value={table&&(prixphoto||table.prixphoto)}
            onChange={(e) => setprixphoto(e.target.value)}
          />
