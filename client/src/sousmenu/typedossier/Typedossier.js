...
export default function FullScreenDialog() {
  ...
  useEffect(() => { 
    ...
    const result =await Axios(
      "http://localhost:5000/typedossier",
    );
    await timeout(1000);
...
<Button onClick={handleOpen} style={{borderColor:"transparent",height:"50px",width:"150px",marginLeft:"-3px",fontSize:"12px",color:"white" }}  >Type Dossier </Button>
        <Dialog
        open={open}
        onClose={handleClose}
      ...
      <tr >
        ...
        , fontWeight:"bold", fontSize:"30px"}} >Liste de type dossier </DialogTitle>
          </td>
                   ...
                   <React.Fragment>
                    ...
                    ,marginLeft:"4px"}} onClick={handleClickOpen}>
                     ...
                     <Button onClick={handleClose} style={{ padding: "5px", marginLeft: "500px",width:"3px"
                       ...
                       <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
                       , fontWeight:"bold", fontSize:"30px"}} >Ajouter un type</DialogTitle>
                    ...
                    ,marginLeft:"4px"}} onClick={handleClickOpen}>
                      ...
                      <Button onClick={handleClose} style={{ padding: "5px", marginLeft: "500px",width:"3px"
                       , backgroundColor:"#c72120", color:"white",height:"25px"}} >X</Button>
                        ...
                        <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
                       , fontWeight:"bold", fontSize:"30px"}}  >Supprimer un type</DialogTitle>
                        <p>{msg}</p>
                        <DialogContent>
                          <TextField 
                            autoFocus
                    ...
                    ,marginLeft:"4px"}} onClick={handleClickOpen}>
                      ...
                      <Button onClick={handleClose} style={{ padding: "5px", marginLeft: "530px",width:"3px"
                       , backgroundColor:"#c72120", color:"white",height:"25px"}} >X</Button>
                        ...
                        <DialogTitle style={{color:'#6e5244' , marginLeft:"100px", fontFamily:"cursive"
                       , fontWeight:"bold", fontSize:"30px"}}  >Modifier un type</DialogTitle>
                        <p>{msg}</p>
                        <DialogContent>
                          <TextField 
                            autoFocus
